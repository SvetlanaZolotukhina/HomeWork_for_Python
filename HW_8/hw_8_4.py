...
class Printer(StoreMashines):
    def to_print(self):
        return f'Я принтер {self.name} и я могу распечатать  {self.numb} раз ваш документ'


class Scanner(StoreMashines):
    def to_scan(self):
        return f'Я сканер {self.name}  и я могу отцифровать {self.numb} раз ваш документ'

class Copier(StoreMashines):
    def to_copier(self):
        return f'Я ксерокс {self.name}  и я могу сделать  {self.numb} копий вашего документа'
